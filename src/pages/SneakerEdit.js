...
const SneakerEdit = () => {
  ...
  return (
    <div className="bg-blue-main w-100 monitor-setting">
      ...
      <div id="edit-monitor" className="container mt-4 px-4 ">
                  ...
                  <Card.Body className="card-bdr bdr-radius-9 p-3">
                    <div className="d-flex flex-column align-items-start gap-2 ">
                      <div className="d-flex align-items-center justify-content-between w-100">
                        ...
                        <div className="d-flex align-items-center justify-content-center p-1 bg-gray rounded-circle">
        ...
        <Modal.Body className="pb-0">
          <Form>
            ...
            <Form.Group md="4" controlId="validationCustom01" className="py-2">
              ...
              <div className="multi-range-slider pt-3">
                <input
                  type="range"
                  min="0"
                  max="100"
